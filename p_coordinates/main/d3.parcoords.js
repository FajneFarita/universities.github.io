...
pc.compute_centroids = function(row) {
  var centroids = [];
...
function compute_control_points(centroids) {
	...
	cps.push(([centroids[0].e(1) + a*2*(centroids[1].e(1)-centroids[0].e(1)), centroids[0].e(2)]));
	...
	cps.push(([centroids[cols-1].e(1) + a*2*(centroids[cols-2].e(1)-centroids[cols-1].e(1)), centroids[cols-1].e(2)]));
